...
**Source ADR:** [ADR-005](../../ADR/ADR-005-rate-resolution-priority.md), extended by [ADR-013](../../ADR/ADR-013-realized-cost-basis.md) and [ADR-016](../../ADR/ADR-016-p2p-median-max-age.md)
