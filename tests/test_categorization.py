...
V1_TAXONOMY: tuple[tuple[TransactionKind, str], ...] = (
    ...
    (TransactionKind.INCOME, "Loan Repayment"),
    ...
    (TransactionKind.EXPENSE, "Dating"),
    (TransactionKind.EXPENSE, "Gifts"),
    (TransactionKind.EXPENSE, "Leisure"),
    (TransactionKind.EXPENSE, "Personal Care"),
